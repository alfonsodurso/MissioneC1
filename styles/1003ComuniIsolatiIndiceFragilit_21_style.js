...
var style_1003ComuniIsolatiIndiceFragilit_21 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (exp_label_1003ComuniIsolatiIndiceFragilit_21_eval_expression(context) !== null && resolution > 0 && resolution < 70) {
        labelText = String(exp_label_1003ComuniIsolatiIndiceFragilit_21_eval_expression(context));
    }
