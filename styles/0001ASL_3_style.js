var size = 0;
var placement = 'point';
function categories_0001ASL_3(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'ASL AVELLINO':
...
var style_0001ASL_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("AZIENDA_SANITARIA");
    ...
    var style = categories_0001ASL_3(feature, value, size, resolution, labelText,
